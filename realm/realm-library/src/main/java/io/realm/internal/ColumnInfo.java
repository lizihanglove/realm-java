...
/**
 * This object plays two roles:
 * <ul>
 * <li>Its subclasses are a fast cache of column indices, for proxy object</li>
 * <li>It caches table (schema) information used by for StandardRealmObjectSchema and StandardRealmSchema</li>
 * </ul>
 ...
 * <ul>
 * <li>If the column type is a simple type, the link table field is empty</li>
 ...
 * and the column index field is the index of the backlink source field, in the source table
 * </li>
 * </ul>
 *
 * <p>
 * Some instances of this class must be thread-safe.  The class support effectively-final semantices.
 ...
 * <ul>
 * <li>the methods {@code addColumnDetails} and {@code addBacklinkDetails} must be called only from within instance constructors</li>
 * <li>a mutable instance must never be the dst parameter of the two-argument copy method</li>
 * </ul>
 */

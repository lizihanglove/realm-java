...
public class RealmQuery<E extends RealmModel> {
     ...
     */
    //FIXME: GBM - this needs to be tested on field descriptor the terminates in a backlink (should always be false)
     ...
     * @see Required for further infomation.
     */
    //FIXME: GBM - this needs to be tested on field descriptor the terminates in a backlink (should always be true)
